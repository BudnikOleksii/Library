...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.index = function () {
  const parent = this[0].parentNode; // html collection to array with spread operator

  const childs = [...parent.children]; // return only which we looking for
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])().get('https://gorest.co.in/public-api/users?_format=json&access-token=ex3rSEFcY1AXKjsiPE56prRh54Vj0k-YXEBF').then(res => console.log(res));
